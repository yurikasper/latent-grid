...
app = FastAPI(title="Latent Grid Service", version="0.1.0")
...
@app.post("/image", response_model=List[TableResponse], response_model_exclude_none=True)
...
@app.post("/pdf", response_model=List[PdfTableResponse], response_model_exclude_none=True)
